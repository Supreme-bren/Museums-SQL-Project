...
SELECT [State (Administrative Location)], AVG(Revenue) AS AverageRevenue FROM [Portfolio-Project]..museums
...
SELECT [State (Administrative Location)], AVG(Income - Revenue) AS Expenses FROM [Portfolio-Project]..museums
GROUP BY [State (Administrative Location)]
...
--Which regions have the most revenue per capita
